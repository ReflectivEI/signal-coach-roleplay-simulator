...
export const ALL_SCENARIOS = [
  ...
  // ── Vaccines ─────────────────────────────────────────────────────────────────
  {
    ...
    openingScene: "Dr. Evelyn Harper looks up from a stack of prior authorization forms, tired but professional. 'We're running behind, but flu coverage is still a problem for my older patients. What can we realistically fix before the next clinic block?'",
    hcpMood: "frustrated",
