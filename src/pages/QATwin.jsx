...
import { buildDeterministicQaRepReply, buildRepAnswerFirstPromptConstraint, detectHcpQuestionType, enforceRepAnswerFirstContract, normalizeDialoguePunctuation } from "@/lib/qaRepProxy";
  ...
  for (let i = 0; i < maxTurns; i++) {
    try {
      ...
      if (lastHcpQuestionType === "solution_seeking") {
        repText = enforceRepAnswerFirstContract({
          scenario,
          turns,
          draft: repText,
        });
