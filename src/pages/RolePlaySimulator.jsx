...
export default function RolePlaySimulator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-teal-900 text-white">
      <AppHeader maxWidthClassName="max-w-2xl" />
      <div className="max-w-2xl w-full mx-auto text-center space-y-8 px-4 py-12">
        {/* Enterprise Banner */}
