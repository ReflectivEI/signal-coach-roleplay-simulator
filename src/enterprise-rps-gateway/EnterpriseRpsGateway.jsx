...
const demoSteps = [
  {
    label: "1. Select a Scenario",
    text: "Choose a realistic HCP scenario from the library. Each scenario is mapped to real-world clinical challenges.",
    img: "/public/rps-gateway-hero.png",
    highlight: "scenario"
  },
  {
    label: "2. Start the Role Play",
    text: "The HCP opens the conversation. Type or speak your response as the rep.",
    img: "/public/rps-gateway-hero.png",
    highlight: "input"
  },
  {
    label: "3. Get Instant Feedback",
    text: "Receive live, AI-powered coaching after each exchange. See what worked, what didn’t, and why.",
    img: "/public/rps-gateway-hero.png",
    highlight: "feedback"
  },
  {
    label: "4. Iterate & Master",
    text: "Try new strategies, refine your approach, and master effective HCP engagement in a safe, enterprise-grade environment.",
    img: "/public/rps-gateway-hero.png",
    highlight: "repeat"
  }
];

export default function EnterpriseRpsGateway() {
  const [step, setStep] = useState(0);

  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-teal-900 text-white px-4 py-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 px-7 py-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h1 className="text-2xl font-bold text-foreground leading-tight">Enterprise Role Play Simulator Gateway</h1>
