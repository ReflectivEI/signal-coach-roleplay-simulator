...
export async function generateRealtimeFeedback(payload) {
  const prompt = [
    ...
    `3. Value Framing - Is relevance to the HCP demonstrated?`,
    `4. Customer Engagement Cues - Is the HCP engaged or disengaged?`,
    `5. Objection Handling - Are concerns addressed or dismissed?`,
    `6. Conversation Control & Structure - Does the rep guide toward outcomes?`,
