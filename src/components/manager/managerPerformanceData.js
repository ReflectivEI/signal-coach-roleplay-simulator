...
const rawRepSeed = [
  {
    ...
    practiceStreakDays: 11,
    salesPerformance: 4.4,
    salesTrend: "up",
    behavioralMetrics: {
      signalAwareness: { score: 4.6, trend: "up", sessionsObserved: 18 },
      signalInterpretation: { score: 4.3, trend: "up", sessionsObserved: 17 },
      adaptability: { score: 4.0, trend: "flat", sessionsObserved: 15 },
      objectionHandling: { score: 4.1, trend: "up", sessionsObserved: 16 },
      valueCommunication: { score: 4.5, trend: "up", sessionsObserved: 17 },
      commitmentGeneration: { score: 3.7, trend: "up", sessionsObserved: 15 },
      emotionalAttunement: { score: 4.4, trend: "up", sessionsObserved: 16 },
      conversationControl: { score: 4.2, trend: "flat", sessionsObserved: 16 },
    },
    recentCoachingActivity: { coachingSessions30d: 3, managerReviews30d: 2, lastCoachingDate: "2026-03-19" },
    scenarioMix: { liveCall: 6, roleplay: 4, objectionDrill: 2, accessScenario: 3 },
    trainingTypeMix: { video: 2, workshop: 1, simulation: 3, peerPractice: 1 },
    lastPracticeDate: "2026-03-22",
    engagementConsistency: 90,
    observationDepth: 18,
    territoryContext: { marketTrend: "up", accessComplexity: 2, payerPressure: 2, accountComplexity: 4 },
  },
  {
    id: "rep-02",
    name: "Maria Santos",
    ...
    salesPerformance: 3.3,
    salesTrend: "flat",
    behavioralMetrics: {
      signalAwareness: { score: 4.0, trend: "up", sessionsObserved: 11 },
      signalInterpretation: { score: 3.8, trend: "flat", sessionsObserved: 10 },
      adaptability: { score: 3.6, trend: "up", sessionsObserved: 10 },
      objectionHandling: { score: 3.4, trend: "down", sessionsObserved: 9 },
      valueCommunication: { score: 4.1, trend: "flat", sessionsObserved: 10 },
      commitmentGeneration: { score: 3.7, trend: "flat", sessionsObserved: 9 },
      emotionalAttunement: { score: 3.9, trend: "up", sessionsObserved: 10 },
      conversationControl: { score: 3.5, trend: "flat", sessionsObserved: 9 },
    },
    recentCoachingActivity: { coachingSessions30d: 2, managerReviews30d: 2, lastCoachingDate: "2026-03-16" },
    scenarioMix: { liveCall: 2, roleplay: 3, objectionDrill: 2, accessScenario: 2 },
    trainingTypeMix: { video: 2, workshop: 1, simulation: 1, peerPractice: 0 },
    lastPracticeDate: "2026-03-19",
    engagementConsistency: 66,
    observationDepth: 11,
    territoryContext: { marketTrend: "flat", accessComplexity: 4, payerPressure: 5, accountComplexity: 4 },
  },
  {
    id: "rep-03",
    name: "James Park",
    ...
    territory: "Midwest",
    status: "active",
    sessionsCompleted30d: 17,
    coachingModulesCompleted: 8,
    practiceStreakDays: 13,
    salesPerformance: 4.6,
    salesTrend: "up",
    behavioralMetrics: {
      signalAwareness: { score: 4.5, trend: "up", sessionsObserved: 18 },
      signalInterpretation: { score: 4.7, trend: "up", sessionsObserved: 18 },
      adaptability: { score: 3.9, trend: "flat", sessionsObserved: 16 },
      objectionHandling: { score: 4.2, trend: "up", sessionsObserved: 16 },
      valueCommunication: { score: 4.6, trend: "up", sessionsObserved: 18 },
      commitmentGeneration: { score: 4.2, trend: "up", sessionsObserved: 16 },
      emotionalAttunement: { score: 4.3, trend: "flat", sessionsObserved: 17 },
    ...
    scenarioMix: { liveCall: 5, roleplay: 5, objectionDrill: 3, accessScenario: 4 },
    trainingTypeMix: { video: 1, workshop: 2, simulation: 3, peerPractice: 2 },
    lastPracticeDate: "2026-03-22",
  ...
  },
  {
    ...
    salesPerformance: 2.9,
    salesTrend: "down",
    behavioralMetrics: {
      signalAwareness: { score: 2.6, trend: "down", sessionsObserved: 6 },
      signalInterpretation: { score: 3.1, trend: "flat", sessionsObserved: 6 },
      adaptability: { score: 3.2, trend: "up", sessionsObserved: 6 },
      objectionHandling: { score: 3.0, trend: "flat", sessionsObserved: 5 },
      valueCommunication: { score: 2.9, trend: "down", sessionsObserved: 6 },
      commitmentGeneration: { score: 2.8, trend: "down", sessionsObserved: 5 },
      emotionalAttunement: { score: 3.0, trend: "flat", sessionsObserved: 6 },
      conversationControl: { score: 3.1, trend: "flat", sessionsObserved: 5 },
    },
    recentCoachingActivity: { coachingSessions30d: 1, managerReviews30d: 1, lastCoachingDate: "2026-03-10" },
    scenarioMix: { liveCall: 1, roleplay: 1, objectionDrill: 1, accessScenario: 1 },
    trainingTypeMix: { video: 1, workshop: 0, simulation: 1, peerPractice: 0 },
    lastPracticeDate: "2026-03-12",
    engagementConsistency: 36,
    observationDepth: 6,
    territoryContext: { marketTrend: "down", accessComplexity: 5, payerPressure: 4, accountComplexity: 5 },
  },
  {
    id: "rep-05",
    name: "David Chen",
    ...
    salesTrend: "down",
    behavioralMetrics: {
      signalAwareness: { score: 4.0, trend: "up", sessionsObserved: 10 },
      signalInterpretation: { score: 3.9, trend: "flat", sessionsObserved: 10 },
      adaptability: { score: 3.5, trend: "up", sessionsObserved: 9 },
      objectionHandling: { score: 3.8, trend: "flat", sessionsObserved: 9 },
      valueCommunication: { score: 3.3, trend: "down", sessionsObserved: 9 },
      commitmentGeneration: { score: 3.7, trend: "flat", sessionsObserved: 8 },
      emotionalAttunement: { score: 4.1, trend: "up", sessionsObserved: 10 },
      conversationControl: { score: 3.6, trend: "flat", sessionsObserved: 9 },
    },
    recentCoachingActivity: { coachingSessions30d: 2, managerReviews30d: 1, lastCoachingDate: "2026-03-15" },
    scenarioMix: { liveCall: 3, roleplay: 2, objectionDrill: 1, accessScenario: 2 },
    trainingTypeMix: { video: 1, workshop: 1, simulation: 1, peerPractice: 1 },
    lastPracticeDate: "2026-03-17",
    engagementConsistency: 62,
    observationDepth: 10,
    territoryContext: { marketTrend: "flat", accessComplexity: 5, payerPressure: 4, accountComplexity: 5 },
  },
  {
    id: "rep-06",
    name: "Linda Nguyen",
    ...
    behavioralMetrics: {
      ...
      objectionHandling: { score: 2.9, trend: "flat", sessionsObserved: 2 },
      valueCommunication: { score: 3.0, trend: "flat", sessionsObserved: 3 },
      commitmentGeneration: { score: 2.8, trend: "down", sessionsObserved: 2 },
      emotionalAttunement: { score: 3.1, trend: "flat", sessionsObserved: 3 },
      conversationControl: { score: 2.6, trend: "down", sessionsObserved: 2 },
    },
    recentCoachingActivity: { coachingSessions30d: 1, managerReviews30d: 0, lastCoachingDate: "2026-03-06" },
    ...
    engagementConsistency: 16,
    observationDepth: 3,
    territoryContext: { marketTrend: "down", accessComplexity: 5, payerPressure: 5, accountComplexity: 4 },
  },
  {
    id: "rep-07",
    name: "Priya Patel",
    ...
    salesTrend: "up",
    behavioralMetrics: {
      signalAwareness: { score: 4.1, trend: "up", sessionsObserved: 14 },
      signalInterpretation: { score: 4.0, trend: "up", sessionsObserved: 14 },
      adaptability: { score: 3.8, trend: "flat", sessionsObserved: 13 },
      objectionHandling: { score: 3.7, trend: "up", sessionsObserved: 12 },
      valueCommunication: { score: 4.2, trend: "up", sessionsObserved: 14 },
      commitmentGeneration: { score: 3.9, trend: "flat", sessionsObserved: 12 },
      emotionalAttunement: { score: 4.3, trend: "up", sessionsObserved: 13 },
      conversationControl: { score: 3.7, trend: "down", sessionsObserved: 12 },
    },
    recentCoachingActivity: { coachingSessions30d: 3, managerReviews30d: 2, lastCoachingDate: "2026-03-18" },
    scenarioMix: { liveCall: 4, roleplay: 4, objectionDrill: 1, accessScenario: 3 },
  ...
  },
  {
    ...
    salesTrend: "flat",
    behavioralMetrics: {
      signalAwareness: { score: 3.4, trend: "up", sessionsObserved: 8 },
      signalInterpretation: { score: 3.3, trend: "flat", sessionsObserved: 8 },
      adaptability: { score: 3.2, trend: "up", sessionsObserved: 7 },
      objectionHandling: { score: 3.6, trend: "down", sessionsObserved: 7 },
      valueCommunication: { score: 3.5, trend: "flat", sessionsObserved: 8 },
      commitmentGeneration: { score: 3.8, trend: "up", sessionsObserved: 7 },
      emotionalAttunement: { score: 3.1, trend: "down", sessionsObserved: 8 },
      conversationControl: { score: 3.4, trend: "flat", sessionsObserved: 7 },
    },
    recentCoachingActivity: { coachingSessions30d: 2, managerReviews30d: 1, lastCoachingDate: "2026-03-12" },
    ...
    observationDepth: 8,
    territoryContext: { marketTrend: "down", accessComplexity: 4, payerPressure: 5, accountComplexity: 4 },
  },
  {
    id: "rep-09",
    name: "Olivia Brooks",
    ...
    salesTrend: "flat",
    behavioralMetrics: {
      signalAwareness: { score: 3.4, trend: "flat", sessionsObserved: 8 },
      signalInterpretation: { score: 3.5, trend: "up", sessionsObserved: 8 },
      adaptability: { score: 3.7, trend: "down", sessionsObserved: 7 },
      objectionHandling: { score: 3.3, trend: "flat", sessionsObserved: 7 },
      valueCommunication: { score: 3.6, trend: "up", sessionsObserved: 8 },
      commitmentGeneration: { score: 3.2, trend: "flat", sessionsObserved: 7 },
      emotionalAttunement: { score: 3.5, trend: "up", sessionsObserved: 8 },
      conversationControl: { score: 3.4, trend: "flat", sessionsObserved: 7 },
    },
    recentCoachingActivity: { coachingSessions30d: 1, managerReviews30d: 1, lastCoachingDate: "2026-03-09" },
    scenarioMix: { liveCall: 2, roleplay: 2, objectionDrill: 1, accessScenario: 2 },
    trainingTypeMix: { video: 1, workshop: 1, simulation: 1, peerPractice: 0 },
    lastPracticeDate: "2026-03-18",
    engagementConsistency: 54,
    observationDepth: 8,
    territoryContext: { marketTrend: "up", accessComplexity: 2, payerPressure: 2, accountComplexity: 3 },
  },
  {
    ...
    salesTrend: "up",
    behavioralMetrics: {
      signalAwareness: { score: 3.8, trend: "up", sessionsObserved: 12 },
      signalInterpretation: { score: 3.7, trend: "flat", sessionsObserved: 12 },
      adaptability: { score: 3.6, trend: "up", sessionsObserved: 11 },
      objectionHandling: { score: 3.4, trend: "down", sessionsObserved: 11 },
      valueCommunication: { score: 4.0, trend: "up", sessionsObserved: 12 },
      commitmentGeneration: { score: 3.6, trend: "flat", sessionsObserved: 10 },
      emotionalAttunement: { score: 3.7, trend: "up", sessionsObserved: 11 },
      conversationControl: { score: 4.1, trend: "up", sessionsObserved: 11 },
    },
    recentCoachingActivity: { coachingSessions30d: 2, managerReviews30d: 2, lastCoachingDate: "2026-03-18" },
    scenarioMix: { liveCall: 5, roleplay: 2, objectionDrill: 2, accessScenario: 2 },
    trainingTypeMix: { video: 1, workshop: 2, simulation: 1, peerPractice: 1 },
    lastPracticeDate: "2026-03-21",
    engagementConsistency: 72,
    observationDepth: 12,
    territoryContext: { marketTrend: "flat", accessComplexity: 4, payerPressure: 4, accountComplexity: 5 },
  },
  {
    id: "rep-11",
    name: "Jasmine Rivera",
    ...
    salesTrend: "up",
    behavioralMetrics: {
      signalAwareness: { score: 4.4, trend: "up", sessionsObserved: 17 },
      signalInterpretation: { score: 4.5, trend: "up", sessionsObserved: 17 },
      adaptability: { score: 4.3, trend: "up", sessionsObserved: 16 },
      objectionHandling: { score: 4.0, trend: "flat", sessionsObserved: 15 },
      valueCommunication: { score: 4.1, trend: "down", sessionsObserved: 15 },
      commitmentGeneration: { score: 4.2, trend: "up", sessionsObserved: 15 },
      emotionalAttunement: { score: 4.6, trend: "up", sessionsObserved: 16 },
      conversationControl: { score: 4.3, trend: "up", sessionsObserved: 16 },
    },
    recentCoachingActivity: { coachingSessions30d: 4, managerReviews30d: 3, lastCoachingDate: "2026-03-20" },
    scenarioMix: { liveCall: 5, roleplay: 4, objectionDrill: 2, accessScenario: 4 },
    trainingTypeMix: { video: 1, workshop: 2, simulation: 2, peerPractice: 2 },
    lastPracticeDate: "2026-03-22",
    engagementConsistency: 91,
    observationDepth: 17,
  ...
  },
  {
    ...
    salesTrend: "down",
    behavioralMetrics: {
      signalAwareness: { score: 3.1, trend: "flat", sessionsObserved: 5 },
      signalInterpretation: { score: 2.8, trend: "down", sessionsObserved: 5 },
      adaptability: { score: 3.2, trend: "up", sessionsObserved: 4 },
      objectionHandling: { score: 3.3, trend: "flat", sessionsObserved: 4 },
      valueCommunication: { score: 3.0, trend: "flat", sessionsObserved: 5 },
      commitmentGeneration: { score: 3.0, trend: "flat", sessionsObserved: 4 },
      emotionalAttunement: { score: 3.4, trend: "up", sessionsObserved: 5 },
      conversationControl: { score: 2.9, trend: "down", sessionsObserved: 4 },
    },
    recentCoachingActivity: { coachingSessions30d: 1, managerReviews30d: 1, lastCoachingDate: "2026-03-11" },
    scenarioMix: { liveCall: 1, roleplay: 1, objectionDrill: 0, accessScenario: 1 },
    trainingTypeMix: { video: 1, workshop: 0, simulation: 1, peerPractice: 0 },
    lastPracticeDate: "2026-03-13",
    engagementConsistency: 40,
    observationDepth: 5,
    territoryContext: { marketTrend: "down", accessComplexity: 5, payerPressure: 5, accountComplexity: 4 },
  },
  {
    ...
    salesTrend: "flat",
    behavioralMetrics: {
      signalAwareness: { score: 3.6, trend: "flat", sessionsObserved: 9 },
      signalInterpretation: { score: 3.8, trend: "up", sessionsObserved: 9 },
      adaptability: { score: 3.4, trend: "flat", sessionsObserved: 8 },
      objectionHandling: { score: 3.3, trend: "flat", sessionsObserved: 8 },
      valueCommunication: { score: 3.9, trend: "up", sessionsObserved: 9 },
      commitmentGeneration: { score: 3.5, trend: "flat", sessionsObserved: 8 },
      emotionalAttunement: { score: 4.0, trend: "up", sessionsObserved: 9 },
      conversationControl: { score: 3.7, trend: "flat", sessionsObserved: 8 },
    },
    recentCoachingActivity: { coachingSessions30d: 2, managerReviews30d: 1, lastCoachingDate: "2026-03-15" },
    scenarioMix: { liveCall: 2, roleplay: 3, objectionDrill: 1, accessScenario: 2 },
    trainingTypeMix: { video: 1, workshop: 1, simulation: 1, peerPractice: 1 },
    lastPracticeDate: "2026-03-20",
    engagementConsistency: 65,
    observationDepth: 9,
  ...
  },
  {
    ...
    salesTrend: "flat",
    behavioralMetrics: {
      signalAwareness: { score: 3.4, trend: "flat", sessionsObserved: 7 },
      signalInterpretation: { score: 3.1, trend: "down", sessionsObserved: 7 },
      adaptability: { score: 3.2, trend: "up", sessionsObserved: 6 },
      objectionHandling: { score: 3.3, trend: "flat", sessionsObserved: 6 },
      valueCommunication: { score: 3.6, trend: "up", sessionsObserved: 7 },
      commitmentGeneration: { score: 3.5, trend: "flat", sessionsObserved: 6 },
      emotionalAttunement: { score: 3.7, trend: "up", sessionsObserved: 7 },
      conversationControl: { score: 3.4, trend: "flat", sessionsObserved: 6 },
    },
    recentCoachingActivity: { coachingSessions30d: 1, managerReviews30d: 1, lastCoachingDate: "2026-03-13" },
    scenarioMix: { liveCall: 2, roleplay: 2, objectionDrill: 0, accessScenario: 2 },
    trainingTypeMix: { video: 1, workshop: 1, simulation: 1, peerPractice: 0 },
    lastPracticeDate: "2026-03-18",
    engagementConsistency: 56,
    observationDepth: 7,
