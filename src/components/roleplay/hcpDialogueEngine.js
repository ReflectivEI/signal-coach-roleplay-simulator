...
export function recalibrateHcpDialogueAndCue(question, currentTab) {
  ...
  if (topicDetected === currentTab) {
    if (topicDetected === "Cost/Response & Toxicity") {
      hcpDialogue = "Our P&T committee is focused on cost-effectiveness and managing IO toxicity. Can you explain how this ADC fits into our pathway with those concerns in mind?";
      ...
      hcpDialogue = "Which specific biomarker-driven patient subset is this ADC targeting? What improvements can we expect in OS/PFS for these patients?";
      ...
      hcpDialogue = "That’s a great question! How does this ADC improve overall treatment in terms of patient subset, cost, and treatment management?";
    ...
    hcpDialogue = `That's a great question! This topic seems to relate more closely to [${topicDetected}]`;
