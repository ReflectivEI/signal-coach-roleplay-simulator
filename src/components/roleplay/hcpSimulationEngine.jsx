...
export function buildHCPDialoguePrompt({
  ...
  prompt += '- In LOW or declining engagement states, avoid repeating the same key phrase across turns; vary wording while preserving the same concern.\n'
  prompt += '- Once the core issue is established, do not fully restate it each turn; reference it briefly and move forward.\n'
  prompt += '- Under engagement pressure, become slightly more direct and slightly less detailed, while staying natural and professional.\n'
  prompt += '- In lower engagement, stay involved but be selective about how much explanation or reframing you provide.\n'
  ...
  prompt += '- Stage 3 Demand Specificity: request one concrete next step, implementation adjustment, or immediate operational implication.\n'
