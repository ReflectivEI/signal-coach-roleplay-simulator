...
export default function CapabilityFeedbackPanel({ messages, turns = [], scenario }) {
  ...
  return (
    <div className="px-4 py-3 space-y-2.5">
      <div className="grid grid-cols-[1fr_96px] items-start gap-2 mb-1">
        ...
        <span className="text-sm font-semibold text-gray-700 text-center mt-6">Analyze</span>
      </div>
      {focusCaps.length > 0 && (
          ...
          <div key={cap.id} className={`rounded-lg border ${hasFeedback ? colors.result : "border-gray-200 bg-white"} overflow-hidden`}>
            ...
            {hasFeedback && isExpanded && (
              <div className="px-3 pb-3 prose prose-sm max-w-none border-t border-gray-100 pt-2">
                <ReactMarkdown
                  components={{
                    p: (props) => <p className="mb-1.5 leading-6 text-[15px] text-slate-700" {...props} />,
