...
const CUE_BANK = {
  ...
  'engaged': [
    ...
    'The HCP glances at the window, then checks the weather, signaling openness to a relaxed conversation.',
    'The HCP adjusts their chair, making space for your materials.',
    'The HCP offers a slight smile, then gestures to a coffee mug, inviting informal rapport.',
    'The HCP briefly checks their badge, then resumes attentive listening.',
    'The HCP places their stethoscope on the desk, signaling readiness to focus on your topic.',
    ...
    'The HCP leans in, elbows on knees, showing deep engagement.',
    'The HCP points to a patient chart, inviting your input.',
    'The HCP scribbles notes rapidly, eager to capture your insights.',
    'The HCP gestures toward a shared screen, collaborating on data.',
    'The HCP offers a warm handshake, signaling strong partnership.',
    ...
    'The HCP glances at a wall clock, then signals urgency with a raised eyebrow.',
    'The HCP stands near the door, body angled for departure.',
    'The HCP checks a pager, then gestures for a quick summary.',
    'The HCP stacks paperwork, signaling the need to wrap up.',
    'The HCP offers a quick nod, then moves toward a waiting patient.',
    ...
    'The HCP purses their lips, then glances at a policy poster.',
    'The HCP shifts in their seat, arms crossed tightly.',
    'The HCP references a guideline binder, challenging your claim.',
    'The HCP looks at a colleague, seeking backup.',
    'The HCP taps a pen, signaling skepticism.',
    ...
    'The HCP closes a laptop, then states their limits.',
    'The HCP moves a chair back, creating physical distance.',
    'The HCP points to a schedule, reinforcing boundaries.',
    'The HCP stands, then gestures for a topic change.',
    'The HCP references a policy document, ending the discussion.',
    ...
    'The HCP clenches their jaw, then sighs audibly.',
    'The HCP rubs their temples, signaling frustration.',
    'The HCP snaps a pen shut, then avoids eye contact.',
    'The HCP shifts papers abruptly, signaling impatience.',
    'The HCP mutters under their breath, then signals to end the conversation.',
    ...
    'The HCP checks their phone, then moves toward the hallway.',
    'The HCP packs up a laptop, signaling departure.',
    'The HCP waves briefly, then leaves the room.',
    'The HCP glances at a patient chart, then signals closure.',
    'The HCP stands, then opens the door for you to exit.',
