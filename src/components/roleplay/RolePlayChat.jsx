...
${actionText}`;
  ...
  // ─── FEEDBACK VIEW ────────────────────────────────────────────────────────────
  // Consolidated flow: Sections 1–4 render inside the End & Get Feedback tab below
          ...
          {activeTab === "capabilities" && (
            <div className="flex-1 overflow-y-auto">
              <div className="px-4 pt-4 pb-2">
                ...
                >
                  {isEnding ? "Generating feedback…" : feedback ? "Regenerate Sections 1-4" : "Generate Sections 1-4"}
                </button>
              </div>
              ...
              {/* Sections 1-4: Render feedback markdown below CapabilityFeedbackPanel */}
              {isEnding && (
